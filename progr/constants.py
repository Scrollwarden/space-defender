...
SCREEN_WIDTH = 256+0 # bust be improved before enlarging
SCREEN_HEIGHT = 256
...
SCORE_DESTROYER_FIRE_RATE, SCORE_BOOSTER = 1000, 1000
SCORE_DRONE_SPEED3, SCORE_TRIPLE_TIR = 1200, 1200
# victoire niveau 2
...
PLAYER_LIFE = 6
PLAYER_SPEED = 2 +0.5
TARGETING_SLOWING = 0.5 +0.5 # la vitesse du joueur réduit lorsqu'il vise avec le canon normal
...
DREADNOUGHT_LIFE = 200
DREADNOUGH_SHIELD_POWER = 10
DREADNOUGH_PATTERN_DURATION = 60
